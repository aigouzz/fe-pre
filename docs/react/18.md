<font style="font-size: 36px;">React中组件之间过渡动画如何实现</font>
...
在react中实现过渡动画效果会有很多种选择，如<strong>react-transition-group，react-motion，Animated，以及原生的CSS</strong>都能完成切换动画
